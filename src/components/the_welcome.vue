...
import CommunityIcon from './icons/icon_community.vue'
import DocumentationIcon from './icons/icon_documentation.vue'
import EcosystemIcon from './icons/icon_ecosystem.vue'
import SupportIcon from './icons/icon_support.vue'
import ToolingIcon from './icons/icon_tooling.vue'
import WelcomeItem from './welcome_item.vue'
</script>
